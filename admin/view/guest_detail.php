              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <h2>Guest ID:<?php echo $detail['id']; ?></h2>

                     <ul class="nav navbar-right panel_toolbox">
                      <li> <a href="add_guest.php?id=<?php echo $detail['id']; ?>&action=edit"><button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></button></a></li>
